...
<title>Fast Quote Insurance | Register Vehicle</title>
...
<form name="myform" action="AddVehicle" method="post" onsubmit="return validate()">
<table cellspacing="50px">
    ...
    <td>Model</td>
    <td>:</td>
    <td><select id="dropbox" name="model" >
		</select>
    </td>
    </tr>
    ...
    for(int i=0;i<10;i++){
    %>
    <option value=<%=yyyy-i %> ><%=yyyy-i %></option>	
    <%
    }
    %>
    </td>
    ...
    <td>On Road Price</td>
    <td>:</td>
    <td><input type="text" id="textbox" name="orp" placeholder=" Price" />
    </td>
    </tr>
    
	<tr><td colspan="3"><input type="checkbox"  name="agreement" > I Accept the licence Agreement</input></td></tr>

<tr style="text-align:center;"><td><input type="submit" id="button1"  value="Submit" />
